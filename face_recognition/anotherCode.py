...
def detect_color_and_hsv(frame):
    ...
    return color, h_val, s_val, v_val
...
try:
    while True:
        ...
        color, h_val, s_val, v_val = detect_color_and_hsv(frame)

        # Draw the ROI
        cv2.rectangle(frame, (310, 230), (330, 250), (0, 0, 0), 4)

        # Show color name
        cv2.putText(frame, f"Color: {color}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,255,255), 2)
